...
> **We don't recommend that the defaults values are changed but if this is something that you want to do, simply copy the file into your Cobalt Strike directory and (re)start the teamserver.**

This repository contains an example [TeamServer.prop](https://github.com/Cobalt-Strike/teamserver-prop/blob/main/TeamServer.prop). 
